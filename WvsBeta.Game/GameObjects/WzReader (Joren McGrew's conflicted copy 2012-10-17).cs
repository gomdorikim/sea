    ...
    public class DataProvider
    {
                ...
                while (Reader.BaseStream.Position < Reader.BaseStream.Length)
                {
                    ...
                    switch (Type)
                    {
                        case ParseTypes.Maps:
                            Program.MainForm.LogAppendFormat("Starting reading maps...");
                            Maps = new Dictionary<int, Map>();
                            ReadMaps();
                            Reader.DoCheck();
                            Program.MainForm.LogAppendFormat("Done.");
                            break;
                        case ParseTypes.Equips:
                            Program.MainForm.LogAppendFormat("Starting reading equips...");
                        ...
                        case ParseTypes.NPCs:
                            Program.MainForm.LogAppendFormat("Starting reading ncps...");
                        ...
                        case ParseTypes.Items:
                            Program.MainForm.LogAppendFormat("Starting reading items...");
                        ...
                        case ParseTypes.Mobs:
                            Program.MainForm.LogAppendFormat("Starting reading mobs...");
                        ...
                        case ParseTypes.Skills:
                            Program.MainForm.LogAppendFormat("Starting reading skills...");
                        ...
                        case ParseTypes.Drops:
                            Program.MainForm.LogAppendFormat("Starting reading drops...");
                        ...
                        case ParseTypes.Pets:
                            Program.MainForm.LogAppendFormat("Starting reading pets...");
        ...
        private static void ReadSkills()
        {
            ...
            for (short i = 0; i < Count; i++)
            {
                ...
                for (byte j = 0; j < levels; j++)
                {
                    ...
                    sld.WeaponDefense = Reader.ReadInt16();
                    sld.MagicDefense = Reader.ReadInt16();
                    sld.Accurancy = Reader.ReadInt16();
                    sld.Avoidability = Reader.ReadInt16();

                    sld.ElementFlags = Reader.ReadByte();
        ...
        private static void ReadMobs()
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                ...
                data.HPTagColor = Reader.ReadUInt32();
                data.HPTagBgColor = Reader.ReadUInt32();
                data.PublicReward = Reader.ReadBoolean();
                data.ExplosiveReward = Reader.ReadBoolean();
                data.Flies = Reader.ReadBoolean();
                ...
                if (hasInfo)
                {
                    ...
                    for (int s = 0; s < tamount; s++)
                    {
                        ...
                        switch (day)
                        {
                            ...
                            default: Program.MainForm.LogAppendFormat("WasDit: {0}", val); continue;
                        }
