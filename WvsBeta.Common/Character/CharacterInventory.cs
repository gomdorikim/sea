...
namespace WvsBeta.Game {
	...
	public class CharacterInventory {
		...
		public void LoadInventory() {
			Server.Instance.CharacterDatabase.RunQuery("SELECT mesos, equip_slots, use_slots, setup_slots, etc_slots, cash_slots FROM characters WHERE id = " + mCharacter.ID.ToString());
			...
			Server.Instance.CharacterDatabase.RunQuery("SELECT mapindex, mapid FROM teleport_rock_locations WHERE charid = " + mCharacter.ID.ToString());
			...
			Server.Instance.CharacterDatabase.RunQuery("SELECT * FROM items WHERE charid = " + mCharacter.ID.ToString());
			data = Server.Instance.CharacterDatabase.Reader;
